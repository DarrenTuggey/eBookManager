...
namespace eBookManager
{
    public partial class eBookManager : Form
    {
        ...
        private async void eBookManager_Load(object sender, EventArgs e)
        {
            ...
            this.btnReadEbook.Location = new Point(103, 227);
            this.btnReadEbook.Name = "btnReadEbook";
            this.btnReadEbook.Size = new Size(36, 40);
            ...
            this.btnReadEbook.Click += new EventHandler(this.btnReadEbook_Click);
            // eBookManager Icon
            this.Icon = new Icon("ico/mainForm.ico");
        ...
        private void lstStorageSpaces_MouseClick_1(object sender, MouseEventArgs e)
        {
            ListViewItem selectedStorageSpace = lstStorageSpaces.SelectedItems[0];
            int spaceID = selectedStorageSpace.Name.ToInt();
            txtStorageSpaceDescription.Text = (from d in _spaces
